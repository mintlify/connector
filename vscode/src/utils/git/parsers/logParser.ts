...
import { filterMap } from '../../../../../../../Documents/repos/vscode-gitlens/src/system/array';
import { normalizePath, relative } from '../../../../../../../Documents/repos/vscode-gitlens/src/system/path';
import { getLines } from '../../../../../../../Documents/repos/vscode-gitlens/src/system/string';
import {
	GitCommit,
	GitCommitIdentity,
	GitCommitLine,
	...
	GitUser,
	isUserMatch,
} from '../../../../../../../Documents/repos/vscode-gitlens/src/git/models';
...
export class GitLogParser {
	...
	static create<T extends Record<string, unknown>>(
		...
		for (const key in fieldMapping) {
			keys.push(key);
			format += `${options?.fieldPrefix ?? ''}${fieldMapping[key]}${options?.fieldSuffix ?? (options?.fieldPrefix == null ? '%x00' : '')
				}`;
		}
