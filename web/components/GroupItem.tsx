      ...
      <div className="min-w-0 space-y-2">
        ...
        <a className="relative group flex items-center space-x-2.5">
          <span className="flex items-center space-x-2.5 text-sm text-gray-500 truncate">
            <div>
              { group.isLoading
                ? <span className="flex items-center text-gran-400 animate-pulse">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512" className="h-3 w-3 text-gray-500 mr-2 animate-spin">
