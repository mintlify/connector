...
export default function TaskItem({ task, onCompleteTask }: { task: Task, onCompleteTask: (task: Task) => void }) {
  ...
  switch (task.type) {
    case 'update':
      taskIcon = <div className="flex items-center justify-center text-red-400 p-1 rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4" viewBox="0 0 512 512" fill="currentColor">
