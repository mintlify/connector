...
export default function TaskItem({ task, onCompleteTask }: { task: Task, onCompleteTask: (task: Task) => void }) {
  ...
  switch (task.type) {
    case 'update':
      taskIcon = <div className="flex items-center justify-center bg-red-100 text-red-400 p-2 rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-3" viewBox="0 0 512 512" fill="currentColor">
