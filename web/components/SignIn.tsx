...
export default function SignIn() {
  ...
  const validateEmail = (values: any) => {
    ...
    else if (!/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(values.email.trim())) errors.email = "Invalid email address"
  ...
  return (
    <Formik
      ...
      onSubmit={(values) => handleSubmit(values.email.trim())}
            ...
            {isSubmitted && (
              <div className="mt-6 rounded-md bg-green-200 px-4 py-3">
                <div className="flex justify-center items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-green-800">Confirmation email sent to {values.email}</p>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="mt-6">
                ...
                <Form className="mt-8 space-y-6">
                  ...
                  <div className="rounded-md space-y-2">
                    ...
                    <ErrorMessage name="email" component="p" className="text-red-500 bg-transparent border-0" />
                  </div>
